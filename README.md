...
Gathering my own images posed the challenge of having to correclty classify each image itself. Here is a video of me correclty classifying each image to use for correct model training.
